...
function SF_scripts() {
	...
	// Set date for years_since and years_since_war
	function setDates() {
		var this_year = new Date().getFullYear();
		var end_of_war = 1945;
		var year_it_happened = 1943
		var years_since = this_year - year_it_happened;
		var years_since_war = this_year - end_of_war;
		document.getElementById("years_since").textContent = years_since;
		document.getElementById("years_since_war").textContent = years_since_war;
	}
	setDates();
